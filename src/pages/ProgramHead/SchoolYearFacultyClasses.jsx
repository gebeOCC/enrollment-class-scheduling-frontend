...
function SchoolYearFacultyClasses() {
    ...
    return (
        <div className="space-y-4">
            ...
            {filteredFaculties.map((faculty, index) => (
                ...
                >
                    <h1
                        className="text-4xl font-bold text-blue-700 tracking-wide border-b-2 border-gray-300 pb-2"
                    >
                        {formatFullNameFML(faculty)} ({faculty.schedules.length} classes)
                    </h1>
...
export default SchoolYearFacultyClasses;
