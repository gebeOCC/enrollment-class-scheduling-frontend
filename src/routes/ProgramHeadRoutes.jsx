...
const EnrollmentSubjectsSchedules = lazy(() => import("../pages/ClassScheduling/EnrollmentSubjectsSchedules"));
    ...
    <>
        ...
        {(enrollmentOngoing || preparation) &&
            <>
                ...
                <Route path="/subjects-schedules" element={<EnrollmentSubjectsSchedules />} />
