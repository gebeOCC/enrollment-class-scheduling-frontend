...
function SideBar() {
    ...
    return (
        <div className="flex h-screen overflow-hidden">
            <div className={`h-full fixed top-0 left-0 z-50 sm:h-auto sm:static bg-[#3e5c76] text-white flex-shrink-0 flex-col justify-between lg:block transition-all duration-300 ease-in-out ${sidebarOpen ? 'w-64' : 'w-20 hidden sm:block'}`}>
                <div className="flex flex-col h-full">
                    <div className="p-4 flex items-center h-14 mb-4">
                        <HiBars3 onClick={toggleSidebar} className="sm:hidden cursor-pointer  transition-transform duration-300 ease-in-out transform
